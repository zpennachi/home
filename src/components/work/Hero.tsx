...
export function Hero() {
    return (
        <section className="h-[calc(100dvh-9rem)] w-full relative flex flex-col justify-start overflow-hidden">
            ...
            {/* Content Layer */}
            <div className="relative z-10 h-full flex flex-col justify-start container pt-6 pb-8 md:pt-8 md:pb-12 pointer-events-none">
                ...
                <div className="w-full">
                    <motion.h1
                        ...
                        className="text-3xl md:text-5xl font-extralight tracking-tight leading-[1.1] text-foreground w-full"
                    >
                    ...
                    <motion.p
                        ...
                        className="mt-6 w-full max-w-none text-sm md:text-base font-normal leading-relaxed text-foreground pointer-events-auto"
