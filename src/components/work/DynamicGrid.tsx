                        ...
                        return (
                            ...
                            >
                                <Link href={href} className="group cursor-pointer h-full flex flex-col relative">
                                    {/* Image Frame */}
                                    <div className={cn("relative bg-muted overflow-hidden mb-8 transition-all duration-700 ease-[0.2,0,0,1] group-hover:scale-[1.02] edge-accent shadow-2xl shadow-black/5 ring-1 ring-foreground/5", aspectClass)}>
                                        <ProjectThumbnail
                                            id={String(entry.id)}
                                            files={entry.file}
                                            title={entry.title}
