    ...
    return (
        ...
        >
            <div className="container flex items-center justify-between pointer-events-auto">
                <Link href="/new" className="text-lg font-light tracking-[0.15em] hover:opacity-70 transition-opacity">
                    zpennachi<span className="text-accent">.</span>
                </Link>
                <nav className="flex items-center gap-4 md:gap-8 text-[11px] font-light uppercase tracking-[0.15em]">
                    ...
                    <Link href="/new/contact" className="hover:opacity-70 transition-opacity px-3.5 py-1.5 border border-white/25 rounded-full hover:border-white/60">
                        Contact
                    </Link>
                </nav>
            </div>
